...
"""
==============================================================================
                         WILD SENTINEL V0.9.9.3
                    ADVERSARIAL SAFETY HARDENING
==============================================================================

V0.9.9.3:

    - Preserves V0.9.9.2 moving-away protection.
    - Preserves canonical spatial exposure validation.
    - Preserves uncertainty envelope behaviour.
    - Preserves hysteresis safety boundaries.
    - Preserves route-crossing detection.
    - Corrects Test 25 so it represents a genuine
      within-observation-window closing trajectory.
    - 26 adversarial safety tests.
...
CORE PRINCIPLES:
    ...
    A TTC OUTSIDE THE CURRENT OBSERVATION WINDOW IS NOT
    A CURRENT CONFLICT.
"""
...
class WildSentinel0993:
    ...
    def time_to_conflict(
        ...
        1. Clearly moving away => NO TTC.
        2. Genuine geometric crossing while closing or maintaining
           distance => valid TTC.
        3. Already inside uncertainty envelope => TTC = 0.
        4. Closing into uncertainty envelope => projected TTC.
        5. Closing but not reaching the envelope within the current
           observation interval => TTC is UNKNOWN for current
           conflict classification.

        A geometric line crossing must NOT override clear
        moving-away evidence.
        """
        ...
        # ------------------------------------------------------------------
        # 3. ALREADY INSIDE UNCERTAINTY ENVELOPE
        # ------------------------------------------------------------------
        ...
        # Outside the engine's useful horizon.
        if ttc > self.max_ttc:
...
def run_adversarial_tests(
    ...
    #     d1 = 10
    #
    # and therefore an extrapolated TTC of 7.5 minutes.
    #
    # The observation interval was only 5 minutes.
    #
    # That was a valid TTC calculation but an invalid test expectation.
    #
    # This corrected case:
    #
    #     (50,80) -> (50,55)
    #
    # reaches the route uncertainty envelope within 5 minutes.
    # ========================================================================
